...
export class SeedConfig {
    ...
    APP_TITLE = 'SmartPay Anywhere';
    API_ROOT = (this.ENV === 'dev' || this.ENV === 'qa') ? 'https://qaspaapi.bidpal.net' : 'https://spaapi.bidpal.net';
    PAYMENT_API_ROOT = (this.ENV === 'dev' || this.ENV === 'qa') ? 'https://qapay.bidpal.net' : 'https://pay.bidpal.net';
    PLANNER_URL = (this.ENV === 'dev' || this.ENV === 'qa') ? 'https://qa.bidpal.net/login/index.html#/login'
                                      : 'https://my.bidpal.net/login/index.html#/login';
    //QA:
    // API_ROOT = 'https://qaspaapi.bidpal.net';
    // PAYMENT_API_ROOT = 'https://qapay.bidpal.net';
    // PLANNER_URL = 'https://qa.bidpal.net/login/index.html#/login';
    //LOCAL DEV:
    // API_ROOT = 'http://localhost:8761';
    // PAYMENT_API_ROOT = 'https://localhost:8046';
    // PLANNER_URL = 'http://127.0.0.1:8010/login/index.html#/login';
    //REMOTE DEV:
    // API_ROOT = 'http://10.0.1.125:8761';
    // PAYMENT_API_ROOT = 'https://10.0.1.125:8046';
    // PLANNER_URL = 'http://10.0.1.125:8010/login/index.html#/login';
    ...
    QA_DEST = `${this.DIST_DIR}/qa`;
    PROD_DEST = `${this.DIST_DIR}/prod`;
    TMP_DIR = `${this.DIST_DIR}/tmp`;
    SCSS_TMP_DIR = `${this.TMP_DIR}/scss`;
...
function getEnvironment() {
    ...
    let qaKeyword = !!base.filter(o => o.indexOf(ENVIRONMENTS.QA) >= 0).pop();
    if (base && prodKeyword || argv['env'] === ENVIRONMENTS.PRODUCTION) {
        return ENVIRONMENTS.PRODUCTION;
    } else if (base && qaKeyword || argv['env'] === ENVIRONMENTS.QA) {
